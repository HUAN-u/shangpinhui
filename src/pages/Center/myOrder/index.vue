        ...
        <div class="order-content">
            ...
            <div class="orders">
                ...
                <table class="order-item" v-for="order in records" :key="order.id">
                    ...
                    <tbody>
                        <tr v-for="(orderlist, index) in order.orderDetailList" :key="orderlist.skuId">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="orderlist.imgUrl" style="width: 100px; height: 100px;">
                                    <a href="#" class="block-text">包邮 {{ orderlist.skuName }} 新款</a>
            ...
            <div class="choose-order">
                <!-- 页码 每页展示几个数据 共多少页   连续页数    当前第几页-->
            <Pagination @upPage="upPage" :pageNo="this.page" :pageSize="this.limit" :total="this.myOrder.total" :continues="5" :totalPages="this.myOrder.pages"/>
            </div>
        </div>
        <!--猜你喜欢-->
        <div class="like">
